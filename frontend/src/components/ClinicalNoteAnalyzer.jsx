                ...
                {result && (
                    <div className="result-section fade-in">
                        ...
                        {result.clinical_summary && (
                            <div className="glass-card" style={{ padding: '1.5rem', marginBottom: '2rem', background: 'rgba(59, 130, 246, 0.05)', border: '1px solid rgba(59, 130, 246, 0.1)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                                    <span style={{ fontSize: '1.5rem' }}>📋</span>
                                    <h4 style={{ margin: 0, color: 'var(--text-main)' }}>Professional Summary</h4>
                                </div>
                                <p style={{ lineHeight: '1.6', color: 'var(--text-main)', fontSize: '1.05rem' }}>
                                    {result.clinical_summary}
                                </p>
                            </div>
                        )}
